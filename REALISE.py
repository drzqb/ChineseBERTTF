...
def load_model_weights_from_checkpoint_bert(model, checkpoint_file):
    ...
    model.get_layer('encoderglyph').set_weights(weights)
    ...
    model.get_layer('projectpy').set_weights(weights)
    model.get_layer('projectglyph').set_weights(weights)
