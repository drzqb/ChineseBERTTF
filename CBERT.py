...
class USER():
    ...
    def build_model(self, summary=True, print_fn=None):
        ...
        tf.keras.utils.plot_model(model, to_file="CBERT.jpg", show_shapes=True, dpi=900)
    ...
    def train(self):
        ...
        if PARAMS_mode == 'train0':
            ...
            # model.load_weights("modelfiles/CBERT_271k/CBERT.h5")
            ...
            model.save(PARAMS_check + '/CBERT.h5')

            with open(PARAMS_check + '/CBERT.txt', 'w', encoding='utf-8') as fs:
                fs.write(str(number))

        else:
            model = tf.keras.models.load_model(PARAMS_check + '/CBERT.h5',
                                               custom_objects={
            ...
            with open(PARAMS_check + '/CBERT.txt', 'r', encoding='utf-8') as fs:
        ...
        for epoch in range(number, PARAMS_epochs + 1):
            ...
            with open(PARAMS_check + '/CBERT.txt', 'w', encoding='utf-8') as fn:
